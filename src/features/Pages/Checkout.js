...
// one thing to notice our cart data contain product [0] access need to change that

// little change in grid after return 

// form auto save nai hora in chrome
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          ...
          <form className="bg-white px-5 py-6 mt-11 "  
          noValidate
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-10 bg-white max-w-5xl px-0  sm:px-0 lg:px-0">
...
//   selectCurrentOrder,
//   selectStatus, } from '../order/orderSlice';
// import { deleteItemFromCartAsync,
//   selectItems,
//   updateCartAsync, } from '../cart/cartSlice';
