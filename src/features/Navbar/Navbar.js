...
import { Bars3Icon, ShoppingBagIcon, XMarkIcon ,ShoppingCartIcon} from '@heroicons/react/24/outline'
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    >
                      ...
                      {items.length>0 &&<span className="inline-flex items-center  rounded-md mb-6 -ml-2 bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 " >
                        {items.length}</span>}
                  </div>
